...
subroutine init_cycle_prop2(wfn, imethod)
  ...
  complex(kind(0d0)) :: dt, dtci, dtmo, time
...
end subroutine init_cycle_prop2
!################################################################################
