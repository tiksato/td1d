!################################################################################
subroutine grid_fdcoeff

  implicit none

  call grid_fdcoeff_center
  call grid_fdcoeff_forward
  call grid_fdcoeff_backward

end subroutine grid_fdcoeff
!################################################################################
!################################################################################
subroutine grid_fdcoeff_center
!
...
!debug
!write(6,*) 'grid_fdcoeff: centered formula with order ', 2 * fd_ohalf
!write(6,*) 'amat:'
...
end subroutine grid_fdcoeff_center
!################################################################################
!################################################################################
subroutine grid_fdcoeff_forward
!
...
end subroutine grid_fdcoeff_forward
!################################################################################
!################################################################################
subroutine grid_fdcoeff_backward
!
...
end subroutine grid_fdcoeff_backward
!################################################################################
