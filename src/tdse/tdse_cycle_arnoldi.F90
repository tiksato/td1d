!################################################################################
subroutine tdse_cycle_arnoldi(wfn, imethod)
  ...
  do istep = 0, totstep
     ...
     call wfn_arnoldi(time, dt, wfn, hwfn, imethod)
     ...
     if (domask) then
        ...
        stop 'tdse_cycle_arnoldi: wfn_capped nyi.'
     end if
...
end subroutine tdse_cycle_arnoldi
!################################################################################
